...
@section('content')
    @if($questionnaire->start_time > date("Y-m-d H:i:s") && $questionnaire->end_time && $questionnaire->start_time && !$can_preview)
        <h1 class="foreword">问卷尚未开始，敬请期待</h1>
    @elseif($questionnaire->end_time < date("Y-m-d H:i:s") && $questionnaire->end_time && $questionnaire->start_time && !$can_preview)
                                            ...
                                            <td>
                                                <div class="rank_item">
                                                    <label><input type="radio"
                                                                  name="matrix_single_{{ $sub_question->id }}"
                                                                  choice-id="{{ $choice->id }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="rank_item">
                                                @foreach($sub_question->choices as $choice)
                                                    <label><input type="radio"
                                                                  name="matrix_scale_{{ $sub_question->id }}"
                                                                  choice-id="{{ $choice->id }}"
                                                                  question-id="{{ $sub_question->id }}"><span
