@section('modal')
                ...
                <div class="modal-body">
                    <form>
                        <div class="box_question form-group">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" id="optionsRadios4" class="multiple_fill_radio" value="多项填空题">
                                    多项填空题
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" id="optionsRadios5" class="array_radio" value="矩阵单选题">
                                    矩阵单选题
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" id="optionsRadios6" class="rank_radio" value="矩阵量表题">
                                    矩阵量表题
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="optionsRadios" id="optionsRadios7" class="explain_radio" value="段落说明">
                                    段落说明
                                </label>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <input type="checkbox" class="edit_must"> 必填
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <form>
                        ...
                        <div class="jump_content">
                            ...
                            <div class="jump" style="display: none">
                                ...
                                <input type="text">
                                <span style="font-size: 12px;color: #8c8c8c;">（输入跳转题目的题号，输入0表示跳转到最后）</span>
                            </div>
                            <div class="jump_error_tips" style="display: none"> 当前有<span></span>道题，请输入<span></span>到<span></span>的数字
                            </div>
                        </div>
    ...
    <!--模态框结束-->
    <!--确认删除选项模态框-->
    <div class="modal fade confirm_delete_choice_box" id="modal-delete-choice" aria-hidden='true' data-backdrop='static'>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                <div class="modal-footer">
                    <button type="button" class="delete_choice_submit btn btn-primary">确认</button>
                    <button  type="button" class="cancel btn btn-black">取消</button>
                </div>
            </div>
        </div>
